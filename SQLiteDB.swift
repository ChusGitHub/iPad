...
private let SQLITE_STATIC = unsafeBitCast(0, sqlite3_destructor_type.self)// (COpaquePointer(bitPattern:0))
private let SQLITE_TRANSIENT = unsafeBitCast(0, sqlite3_destructor_type.self)// (COpaquePointer(bitPattern:-1))
